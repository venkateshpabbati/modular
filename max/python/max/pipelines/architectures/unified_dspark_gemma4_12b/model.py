...
@dataclass
class UnifiedDSparkGemma4_12BInputs(UnifiedSpecDecodeInputs):
...
class UnifiedDSparkGemma4_12BModel(
    ...
    model_config_cls: ClassVar[type[Any]] = UnifiedDSparkGemma4_12BConfig
    batch_processor_cls: ClassVar[
        type[UnifiedDSparkGemma4_12BBatchProcessor]
    ] = UnifiedDSparkGemma4_12BBatchProcessor
            ...
            Gemma4ForConditionalGenerationConfig.construct_kv_params(
                ...
                cache_dtype_for_encoding(
                    _select_quantization_encoding(
                        ...
                        UnifiedDSparkGemma4_12BConfig.DEFAULT_ENCODING,
                    ),
    ...
    def _audit_state_dict_names(
        self,
        nn_model: UnifiedDSparkGemma4_12BModule,
