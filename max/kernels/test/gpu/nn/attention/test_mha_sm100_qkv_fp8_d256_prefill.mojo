...
"""Correctness test for SM100 MHA with native FP8 Q, K, V (head_dim=256).
...
def execute_pure_fp8_test[
    ...
    *,
    ...
    print(
        "test_mha_sm100_qkv_fp8_d256_prefill: ",
        "mask=",
        mask_name,
        " group=",
        group,
...
# ===-----------------------------------------------------------------------===#
# Entry point — minimal case for initial bring-up
# ===-----------------------------------------------------------------------===#
...
def main() raises:
    with DeviceContext() as ctx:
        ...
        # Gemma4-relevant: group=8 (Gemma4-local), group=4 (a sub-config).
        ...
        print("test_mha_sm100_qkv_fp8_d256_prefill: ALL PASSED")
