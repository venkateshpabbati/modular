...
def histogram_kernel(
    ...
    """GPU histogram kernel with coarsening (interleaved partitioning).
    ...
    # Coarsened processing with interleaved partitioning
...
def main() raises:
    """Example usage of GPU histogram with coarsening (interleaved)."""
    ...
    print(
        "Coarsening with interleaved partitioning (COARSE_FACTOR="
