...
- [Warp-level operations](#warp-level-operations): How to perform fine-grained
  ...
  [`gpu.primitives.warp`](https://mojolang.org/docs/std/gpu/primitives/warp/)
  primitives.
...
The [`gpu.primitives.warp`](https://mojolang.org/docs/std/gpu/primitives/warp/)
module provides five shuffle primitives, each optimized for specific data
movement patterns:

- [`shuffle_up(value, offset)`](https://mojolang.org/docs/std/gpu/primitives/warp/shuffle_up/):
...
- [`shuffle_down(value, offset)`](https://mojolang.org/docs/std/gpu/primitives/warp/shuffle_down/):
...
- [`shuffle_xor(value, offset)`](https://mojolang.org/docs/std/gpu/primitives/warp/shuffle_xor/):
...
- [`shuffle_idx(value, offset)`](https://mojolang.org/docs/std/gpu/primitives/warp/shuffle_idx/):
...
- [`broadcast(value)`](https://mojolang.org/docs/std/gpu/primitives/warp/broadcast/):
...
- [`max(value)`](https://mojolang.org/docs/std/gpu/primitives/warp/max/):
  Computes the maximum `value` across all threads in the warp. The result is
  broadcast to all lanes.

- [`min(value)`](https://mojolang.org/docs/std/gpu/primitives/warp/min/):
  Computes the minimum `value` across all threads in the warp. The result is
  broadcast to all lanes.

- [`sum(value)`](https://mojolang.org/docs/std/gpu/primitives/warp/sum/):
  Computes the sum of `value` across all threads in the warp. The result is
  broadcast to all lanes.

- [`prefix_sum[exclusive=False](value)`](https://mojolang.org/docs/std/gpu/primitives/warp/prefix_sum/):
  Computes an inclusive (default) or exclusive prefix sum (scan) across threads
...
- **Thread fence**
  ([`gpu.intrinsics.threadfence()`](https://mojolang.org/docs/std/gpu/intrinsics/threadfence/)):
...
[`gpu.WARP_SIZE`](https://mojolang.org/docs/std/gpu/globals/#warp_size) constant
